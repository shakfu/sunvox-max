...
1. Build the external (see below)
2. Copy `externals/sunvox~.mxo` to your Max packages or externals folder
3. Copy `help/sunvox~.maxhelp` alongside the external

## Building

```bash
make setup   # Initialize submodules, create symlinks
